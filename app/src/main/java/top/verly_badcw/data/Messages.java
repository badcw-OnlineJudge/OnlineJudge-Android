...
public class Messages {
    ...
    static {
        setup(MainActivity.language());
    }

    private static void setup(Languages lang) {
        strings = new HashMap<>();
        Messages.lang = lang;
    ...
    private static String get(Class c, String k, Object... args) {
        String key;
        if (c != null) {
            key = c.getName().replace("top.verly_badcw.", "");
            key += "." + k;
        } else
            key = k;
